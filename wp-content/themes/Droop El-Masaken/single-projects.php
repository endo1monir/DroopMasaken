        ...
        ?>
                <div class="flex content-comment-date mt-3 mb-3">
                    ...
                    <p>
                        ...
                        <span><?php if (get_comments_number(get_the_ID()) == 0) {
                                    echo 'لا يوجد تعليقات ';
                                } elseif (get_comments_number(get_the_ID()) == 1) {
                                    echo 'تعليق واحد';
                                } elseif (get_comments_number(get_the_ID()) == 2) {
                                    echo 'تعليقان';
                                } else {
                ...
                <div class="row">
                    ...
                    <?php if (get_field('project_gallery')) {
                        ...
                        <div class="div-padding-single edit-padding-col">
                            ...
                            <div class="row img-flats">
                                <div class="col-md-6 ">
                                    <img class="flat1" src="<?php echo $images[0]; ?>" alt="">
                                </div>
                                <div class="col-md-6">
                                    <img class="flat2" class="block mb-2" src="<?php echo $images[1]; ?>" alt="">
                                    <img class="block flat3" src="<?php echo $images[2]; ?>" alt="">
                                </div>
                            </div>
                    ...
                    <div class="div-padding-single">
                        ...
                        <div class="img-single-blog div-about-us relative mb-md-5 mb-3">
                            <img class="img-single-blog-img" src="<?php echo $uploads['baseurl']; ?>/2021/10/realsteat22.png" alt="">
                            <div class="header-content">
                                <a data-fancybox="gallery" class="product1" href="<?php echo get_field('video_project'); ?>">
                                    <div class="prod-img ovrlay-relative">
                                        <img class="width-img-play" src="<?php echo $uploads['baseurl']; ?>/2021/10/video.png" style="visibility: visible;">
                    ...
                    <button type="submit" class="call-nw blue-button"> <span> ارسال الرسالة</span>
                        ...
                        <div class="div-padding-single">
                           ...
                           // echo '<pre>'.print_r($theProjects).'</pre>';
                            ...
                            ?>
                                    <div class="relative content-projs mb-3">
                                        ...
                                        <?php the_post_thumbnail('thumbnail',array('class'=>'width-smll-news')); ?></a>
                                        <div class="div-smll-news animate__animated animate__rubberBand edit-icon">
                                            <div class="flexx">
                                                ...
                                                <p class="service_comments">
                                                    ...
                                                    <?php comments_popup_link('zero تعليق ','1 تعليق','% تعليقات','comment-url-class','comment Disabled'); ?>
                                                </p>
                                            </div>
                                            <p class="theme-color p-news-abs"> <?php the_title();  ?> </p>
                                            <a href="<?php the_permalink() ?>" class="block small-title theme-color uder-line">قراءة
                                                المزيد</a>
                                        </div>
                                    </div>
